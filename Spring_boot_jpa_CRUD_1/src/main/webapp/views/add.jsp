			...
			<form action="addProcess" method="post">
				...
				<div class="mb-3">
					<label for="name" class="form-label">Enter Name*</label> <input
						type="text" class="form-control" id="name" name="personName">
				</div>
				<div class="mb-3">
				...
				<div class="mb-3">
					<label for="email" class="form-label">Email address*</label> <input
						type="email" class="form-control" name="personEmail" id="email"
				...
				<div class="mb-3">
					<label for="password" class="form-label">Password*</label> <input
						type="password" class="form-control" name="personPassword"
						id="password">
				</div>
